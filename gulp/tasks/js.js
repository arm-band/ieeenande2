...
_.gulp.task('js.concat', () => {
    return _.gulp.src([`${dir.assets.jquery}/jquery.min.js`, `${dir.assets.bootstrap}/bootstrap.bundle.min.js`, `${dir.assets.easing}/jquery.easing.js`, `${dir.assets.bowser}/bowser.js`, `${dir.assets.iebuster}/ie-buster.js`, `${dir.assets.lightbox}/js/lightbox.js`])
        .pipe(_.plumber())
